...
class CouriorsModel
{
    ...
    public static function InsertCouriors($courior)
   {
    ...
    $collection = self::$db->selectCollection('halascouriors');
    ...
    {
    self::Init();
    $collection = self::$db->halascouriors;
  ...
  public static function InsertCouriordata($data)
  {
    ...
    $collection = self::$db->halascouriorsdata;
...
{
    self::Init();
    $collection = self::$db->halasaddresses;
