...
public static function CarData($carId)
    {
        $html = '<form method="post" action="'. Config::TATAB_URL_CARDATA .'" enctype="multipart/form-data">';
        ...
        if ($file['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($detectedType, $allowedTypes)) {
                ...
                if (move_uploaded_file($file['tmp_name'], $uploadFile)) {
                    ...
                    header("Location: " . Config::TATAB_URL_CARDATA . "?param=" . htmlspecialchars($carId));
                    exit();
                } else {
